...
function Navbar2() {
  ...
  function isNotLogged() {
    return (
      <div className="auth">
        <li>
          <Link to="/login" className="login"  onClick={() => {setHideNav(true);setPageName("Login Page")}}>
            Login
          </Link>
        </li>
        <li>
          <Link to="/register" className="register" onClick={() => {setHideNav(true);setPageName("Register Page")}}>
            Register
          </Link>
        </li>
      </div>
