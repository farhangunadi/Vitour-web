...
function App() {
    return ( <
        ...
        element = { < About / > }
        />{" "} <
        Route path = "/virtualtour/bandung"
        element = { < Bandung / > }
        />{" "} <
        Route path = "/virtualtour/jakarta"
        element = { < Jakarta / > }
        />{" "} <
        Route path = "/virtualtour/jakarta/kuliner"
        element = { < KulinerJKT / > }
        />{" "} <
        Route path = "/virtualtour/jakarta/budaya"
        element = { < BudayaJKT / > }
        />{" "} <
        Route path = "/virtualtour/jakarta/merch"
        element = { < MerchJKT / > }
        />{" "} <
        Route path = "/virtualtour/jakarta/monas"
        element = { < Monas / > }
        />{" "} <
        Route path = "/virtualtour/purwakarta"
        element = { < Purwakarta / > }
        />{" "} <
        Route path = "/virtualtour/bandung/alun-alun"
        element = { < Alun2 / > }
        />{" "} <
        Route path = "/virtualtour/bandung/kawah-putih"
        element = { < KawahPutih / > }
        />{" "} <
        Route path = "/virtualtour/bandung/kuliner"
        element = { < KulinerBDG / > }
        />{" "} <
        Route path = "/virtualtour/bandung/budaya"
        element = { < BudayaBDG / > }
        />{" "} <
        Route path = "/virtualtour/bandung/merchstore"
        element = { < MerchBDG / > }
        />{" "} <
